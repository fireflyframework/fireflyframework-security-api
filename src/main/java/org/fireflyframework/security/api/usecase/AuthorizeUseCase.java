...
/**
 * Driving port: decide whether a {@link SecurityPrincipal} may perform {@code action} on
 * {@code resource} within the supplied context. Implementations are fail-closed.
 */
